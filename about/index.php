...
<h1>About Us</h1>
    <div id="about-wrap" class="container row">
        <div class="col-9">
            ...
            <h2>What We Do</h2>
            <p class="left-text">Our goal is to make your family's day the best it can be! Giving back to the community is something we've always wanted to do. By providing fun games, delicious foods and great parties, we can take the meaning of enjoyment to reach new heights!</p>
        </div>
        <div class="col-3">
            <h2>Our Team</h2>
            <div id="staff">
