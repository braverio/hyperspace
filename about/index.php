...
<h1>About Us</h1>
    <div id="about-wrap" class="container row">
        <div class="col-9">
            <h2>Our Story</h2>
            <p>Growing up, I didn't get to watch Neil Armstrong and Buzz Aldrin take a giant leap for mankind. I didn't get to watch the Apollo 11 Moon Landing, but this hasn't stopped me from pursuing what I love. I've always been fascinated by our stars and planets and galaxy, and luckily, my interests have passed on to my children. Without a doubt, my chilren are my world. I've combined my two passions to create HyperSpace so that every child in our community will have a fun and safe place to explore the world. So come on by so that we can show you what "out of this world" really means.</p>
            <h2>Who We Are</h2>
            ...
            <h2>What We Do</h2>
            <p>Our goal is to make your family's day the best it can be! Giving back to the community is something we've always wanted to do. By providing fun games, delicious foods and great parties, we can take the meaning of enjoyment to reach new heights!</p>
        </div>
        <div class="col-3">
            <h2>Our Team</h2>
            <div id="staff">
